...
class InitChinstrap:
    ...
    def initContracts(self):
        ...
        Helpers.copyFile(
            f"{self.chinstrapPath}/core/sources/contracts/Originations.py",
            f"{self.path}/contracts/Originations.py",
        )
        Helpers.copyFile(
    ...
    def initOriginations(self):
        ...
        Helpers.copyFile(
            f"{self.chinstrapPath}/core/sources/originations/1_initial_originations.py",
            f"{self.path}/originations/1_initial_originations.py",
        )
        Helpers.copyFile(
            f"{self.chinstrapPath}/core/sources/originations/2_samplecontract_origination.py",
            f"{self.path}/originations/2_samplecontract_origination.py",
        )
