...
type_mappings = {
    ...
    'unit': 'None || Unit /* `from chinstrap.core.pytezos import Unit` for resolving None ambiguity */',
    ...
    'contract': 'str  /* Base58 encoded `KT` address with optional entrypoint */'
                ...
                ' ||\n\tUndefined  /* `from chinstrap.core.pytezos import Undefined` for resolving None ambiguity  */',
