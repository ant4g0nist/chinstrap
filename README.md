<img src="docs/images/logo.png" alt="Chinstrap" style="width:200px;"/>
...
![compile-demo](docs/images/compile-originate.gif)
...
![sandbox-demo](docs/images/sandbox.gif)

To start the chinstrap repl (debug):

![debug-demo](docs/images/debug.gif)
